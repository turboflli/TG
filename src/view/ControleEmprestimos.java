...
public class ControleEmprestimos extends javax.swing.JFrame {
    ...
    public ControleEmprestimos() {
       ...
       /* BasicComboPopup bc=(BasicComboPopup) Lista1.getAccessibleContext().getAccessibleChild(0);
        JList list = bc.getList();
		Container c = SwingUtilities.getAncestorOfClass(JScrollPane.class, list);
        JScrollPane scrollPane = (JScrollPane)c;
        Dimension scrollPaneSize = scrollPane.getPreferredSize();
        scrollPaneSize.width=1200;
        scrollPane.setPreferredSize(scrollPaneSize);
		scrollPane.setMaximumSize(scrollPaneSize);
        Component comboBox = bc.getInvoker();
		Point location = comboBox.getLocationOnScreen();
                int height = comboBox.getPreferredSize().height;
			bc.setLocation(location.x, location.y + height - 1);
			bc.setLocation(location.x, location.y + height);*/
    ...
    private void initComponents() {
        ...
        setTitle("Emprestimos de alunos");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ControleEmprestimos.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControleEmprestimos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ControleEmprestimos().setVisible(true);
            }
        });
    }
